...
namespace DIONYS_ERP.PLANTILLAS
{
    public partial class Formulario_web11 : System.Web.UI.Page
    {
        ...
        protected void imgBtnCONSULTAR_Click(object sender, ImageClickEventArgs e)
        {
            ...
            gvDATOSCONTROL_GALERIA.DataSource = GALERIA.DATOS_GALERIA_ARBITRIOS(rdbLISTAGALERIAS.SelectedItem.Text, cboPROPIETARIOS.SelectedValue.ToString(), cboTIENDAS.SelectedValue.ToString(), cboESTADO.SelectedValue.ToString());
        ...
        protected void gvDATOSCONTROL_GALERIA_RowDataBound1(object sender, GridViewRowEventArgs e)
        {
                ...
                if (rdbPERIODO.SelectedIndex == 0)
                {
                    for (int i = 4; i < 17; i++)
                    {
                        ...
                        if (posicion == -1)
                        {
                            ...
                            {
                                e.Row.Cells[i].BackColor = System.Drawing.Color.Turquoise;
                                e.Row.Cells[i].ForeColor = System.Drawing.Color.White;
                            }
                            else if (i > 9 && i < 13)
                            {

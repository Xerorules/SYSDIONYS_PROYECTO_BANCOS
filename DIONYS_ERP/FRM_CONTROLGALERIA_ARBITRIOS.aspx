<%@ Page Title="" Language="C#" MasterPageFile="~/PLANTILLAS/MENU_SUPERIOR.Master" AutoEventWireup="true" CodeBehind="FRM_CONTROLGALERIA_ARBITRIOS.aspx.cs" Inherits="DIONYS_ERP.PLANTILLAS.Formulario_web11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 style="color:white;font-family: Tahoma ">CONTROL DE TIENDAS GALERIA (ARBITRIOS)</h2>
    <div>
     <fieldset>
    ...
    <div>
        <fieldset>
           ...
           <table>
               <tr>
                    <td style="text-align: center; color:white; font-size:large " class="auto-style28">1ER TRIM: 
                        <asp:Image ID="Color1" runat="server" Height="27px" ImageUrl="~/ICONOS/GOLD.png" Width="29px" />
                    </td>
                    <td style="text-align: center; color:white; font-size:large" class="auto-style28">2DO TRIM: 
                        <asp:Image ID="Color2" runat="server" Height="27px" ImageUrl="~/ICONOS/TUURQUESA.png" Width="29px" />
                    </td>
                    <td style="text-align: center; color:white; font-size:large" class="auto-style28">3ER TRIM: 
                        <asp:Image ID="Color3" runat="server" Height="27px" ImageUrl="~/ICONOS/CHOCOLATE.png" Width="29px" />
                    </td>
                    <td style="text-align: center; color:white; font-size:large" class="auto-style28">4TO TRIM: 
                        <asp:Image ID="Color4" runat="server" Height="27px" ImageUrl="~/ICONOS/ORANGE.png" Width="29px" />
                    </td>
